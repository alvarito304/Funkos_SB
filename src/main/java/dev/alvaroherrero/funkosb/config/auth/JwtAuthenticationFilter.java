package dev.alvaroherrero.funkosb.config.auth;

import dev.alvaroherrero.funkosb.auth.services.jwt.IJwtService;
import dev.alvaroherrero.funkosb.auth.services.users.IAuthUsersService;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    private final IAuthUsersService authUsersService;

    @Autowired
    public JwtAuthenticationFilter(IJwtService jwtService, IAuthUsersService authUsersService) {
